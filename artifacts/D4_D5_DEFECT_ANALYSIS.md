...
| Three selected judgement cases ended in response errors in both live arms | A judgement score would be misleading where no evidence-bearing final reason exists | Left all three verdicts explicitly pending and kept code and judgement rates separate; an actual person or different-family judge must be named before those fields are filled |
